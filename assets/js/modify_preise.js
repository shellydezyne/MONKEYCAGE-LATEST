function edit_row(id)
{
 ...
 document.getElementById("description"+id).innerHTML="<input type='text' id='description"+id+"' value='"+description+"'>";
 document.getElementById("normalhour"+id).innerHTML="<input type='text' id='normalhour"+id+"' value='"+normalhour+"'>";
 document.getElementById("happyhour"+id).innerHTML="<input type='text' id='happyhour"+id+"' value='"+happyhour+"'>";
